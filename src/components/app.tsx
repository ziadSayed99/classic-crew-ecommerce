...
function AppPart() {
  return (
    <main className="bg-gray-100 relative overflow-hidden">
      <div className="bg-gray-100 flex relative  items-center overflow-hidden">
        <div className="container mx-auto px-6 flex relative py-16">
          <div className="bg-gray-100 py-12">
            <div className="container mx-auto text-left mt-24">
              <h1 className="text-4xl font-bold mb-4">The Classic Crew App</h1>
              ...
              <div className="flex flex-col items-left gap-4 md:flex-row md:justify-left">
                <a
                  href=""
                  target="_blank"
                  className="flex items-left justify-center w-auto max-w-sm px-10 py-6 bg-black text-white rounded-xl text-lg" // Increased padding and font size
                  rel="noreferrer"
                >
                  <svg
                    className="w-8 mr-3"
                ...
                <a
                  href=""
                  target="_blank"
                  className="flex items-center justify-center max-w-sm px-10 py-6 bg-black text-white rounded-xl text-md" // Increased padding and font size
                  rel="noreferrer"
                >
                  <svg
                    className="w-8 mr-3"
          ...
          <div className="hidden sm:block sm:w-1/3 lg:w-3/5 relative">
            <img
              src={appimg}
              className="w-full h-auto max-w-md md:max-w-lg m-auto"
              alt="App"
            />
          </div>
        </div>
