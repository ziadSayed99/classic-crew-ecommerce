      ...
      <div className="bg-gray-100 flex relative  items-center overflow-hidden">
        <div className="container mx-auto px-6 flex relative py-16">
          <div className="bg-gray-100">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 text-left">
              {/* Text Section */}
              <div className="md:col-span-6">
                ...
                <div className="flex flex-col items-left gap-4 md:flex-row md:justify-start">
                  <a
                    href=""
                    target="_blank"
                    className="flex items-center justify-center w-auto max-w-sm px-10 py-6 bg-black text-white rounded-xl text-lg"
                    rel="noreferrer"
                  >
                    <svg
                      className="w-8 mr-3"
                  ...
                  <a
                    href=""
                    target="_blank"
                    className="flex items-center justify-center max-w-sm px-10 py-6 bg-black text-white rounded-xl text-md"
                    rel="noreferrer"
                  >
                    <svg
                      className="w-8 mr-3"
